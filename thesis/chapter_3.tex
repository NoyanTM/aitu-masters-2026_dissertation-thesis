...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{secure_software_pipeline.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{overview_of_software_analysis_process_in_dfd_part_1.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{overview_of_software_analysis_process_part_2_with_analysis_engine.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{compromisation_trends_in_simulation.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{integrity_snapshot_in_simulation.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{attack_grid_on_dependencies.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{major_version_distribution.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{android_3_groups_comparison.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{phone_android_version_status_distribution.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{android_latest_patches_and_smartphones_release_dates.pdf}
